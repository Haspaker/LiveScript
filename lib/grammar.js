...
bnf = {
  ...
  Arg: [
    o('Expression'), o('Type Expression', function(){
      return Typed($1, $2);
  ...
  Type: [
    o('TYPE', function(){
      return [Var($1)];
    }), o('Type CASE TYPE', function(){
      return $1.concat(Var($3));
    }), o('Type ?', function(){
      return $1.concat([Var('n'.toUpperCase() + 'ull'), Var('u'.toUpperCase() + 'ndefined')]);
    })
  ],
  OptComma: [o(''), o(',')],
  Lines: [
  ...
  Property: [
    ...
    }), o('KeyValue'), o('Type KeyValue', function(){
      return Typed($1, $2);
    }), o('KeyValue LOGIC Expression', function(){
      return Binary($2, $1, $3);
